...
class SortedFrozenSet(Sequence, Set):
  ...
  def __iter__(self):
    # First option: Low level, create iterator -> Fastest
    # return iter(self._items)
    # Second option: Need to crerate a custom iterator class
    # return SortedFrozenSetIterator(self)
    # Third option: Generator function returning an iterable generator object
